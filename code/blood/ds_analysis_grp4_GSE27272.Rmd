...
# grab phenotype data
ls(gse.obj1)
p1_gpl570 <- pData(gse.obj1$GSE27272_series_matrix.txt.gz)
...
smok_vars <- p1_gpl570 %>% 
  select(geo_accession, "title") %>%
        # , "characteristics_ch1.1", "characteristics_ch1.2", "characteristics_ch1.3", "characteristics_ch1.4") %>%
  rename(smoker="title")#, copd="characteristics_ch1.4")
