...
# grab phenotype data
ls(gse.obj1)
p1_gpl570 <- pData(gse.obj1$GSE30063_series_matrix.txt.gz)
...
smok_vars2 <- smok_vars %>%
  mutate(smoker = case_when(
    str_detect(smok_vars$smoker, "smoking status: nonsmoker") ~ "nonsmoker",
    str_detect(smok_vars$smoker, "smoking status: S") ~ "smoker",
    str_detect(smok_vars$smoker, "smoking status: smoker") ~ "smoker"
))
