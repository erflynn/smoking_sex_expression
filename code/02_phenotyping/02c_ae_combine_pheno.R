# 02a_ae_combine_pheno.R
# 11/24/2020
# 
# Code for combining phenotype data, also used for dividing into discovery and validation
# 
# TODO:
#  - where is the code for combining the previous AE data?
#  - try to rescue data missing smoking information?
...
# AE only metadata
comb_data_sl_filt3 %>% filter(!tissue %in% c("bronchial epithelium",
                          "alveolar macrophages")) %>%
  write_csv("data/ae_only_meta.csv")
